...
const Navbar = ({setTab}) => {
  ...
  <defs>
    <clipPath id="a">
      ...
      <ul className="pr-5 flex w-1/2 md:w-1/3 justify-between md:justify-around ">
        <li className="text-sm md:text-xl font-bold" onClick={()=>setTab(0)}>HOME</li>
        <li className="text-sm md:text-xl font-bold" onClick={()=>setTab(1)}>CART</li>
      </ul>
    </div>
  )
}
